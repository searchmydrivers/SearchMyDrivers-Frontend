...
const RegistrationPopup = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-md transition-opacity duration-500" style={{ animation: 'fade-in 0.4s cubic-bezier(0.16, 1, 0.3, 1)' }}>
            ...
            `}</style>
            <div className="bg-white rounded-[32px] w-full max-w-2xl overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-white/20 relative" style={{ animation: 'slide-down 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)' }}>
                {/* Close Button */}
                <button
                    onClick={handleClose}
                    className="absolute top-4 right-4 p-2 rounded-full bg-gray-100 text-gray-500 hover:bg-red-50 hover:text-red-500 transition-all z-10"
                >
                ...
                <div className="flex flex-col md:flex-row h-full">
                    ...
                    <div className="md:w-2/5 bg-gradient-to-br from-[#2BB673] to-[#239960] p-8 text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    {/* Right Side - Form */}
                    <div className="md:w-3/5 p-6 md:p-10 bg-[#fdfdfd] overflow-y-auto max-h-[90vh] custom-scrollbar">
                        <div className="mb-6">
                        ...
                        <div className="flex p-1.5 bg-gray-100/80 rounded-2xl mb-8">
                            <button
                                ...
                                className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg font-bold text-sm transition-all ${activeTab === 'user' ? 'bg-white text-[#239960] shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg font-bold text-sm transition-all ${activeTab === 'partner' ? 'bg-[#239960] text-white shadow-md shadow-green-200' : 'text-gray-500 hover:text-gray-700'}`}
                            >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="relative group">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-[#2BB673]/20 focus:border-[#2BB673] focus:bg-white outline-none transition-all text-sm font-medium"
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        rows="3"
                                        className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-[#2BB673]/20 focus:border-[#2BB673] focus:bg-white outline-none transition-all text-sm font-medium resize-none"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-[#2BB673] to-[#239960] text-white font-bold py-4 rounded-2xl shadow-lg shadow-green-200 hover:shadow-xl hover:shadow-green-300 hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-70 flex items-center justify-center gap-2 mt-2"
                            >
                                {loading ? (
