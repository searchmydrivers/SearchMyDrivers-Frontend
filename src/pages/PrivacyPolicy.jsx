...
const PrivacyPolicy = () => {
    return (
        <div className="font-sans antialiased text-gray-900 bg-gray-50 min-h-screen">
            <Helmet>
                <title>Privacy Policy | SearchMyDrivers</title>
                <meta name="description" content="Read the privacy policy of SearchMyDrivers to understand how we collect, use, and protect your personal data." />
                <link rel="canonical" href="https://searchmydrivers.com/privacy-policy" />
            </Helmet>
            <Navbar />
